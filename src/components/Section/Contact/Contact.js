...
import { FaFacebookF, FiInstagram, BsGithub} from "react-icons/fa";
...
const Contact = () => {
    return(
        ...
        <div className="contact" dest="contact">
